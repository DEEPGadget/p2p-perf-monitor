...
서버 2대(각 1× Mellanox ConnectX-6 200G RoCE) 간 P2P 통신 성능을 실시간 측정·시각화하는 Web 기반 데모 도구. 전시회 시연 용도.
...
- NIC: ConnectX-6 200G, MLNX_OFED 사전 설치 → `context/nic-environment.md`
...
context/
  nic-environment.md       ConnectX-6 200G + MLNX_OFED 사전 조건
